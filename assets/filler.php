<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="<?php echo $path ?>assets/media/logo.svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect width="100%" height="100%" fill="#777"></rect></svg>
      ...
      <div class="carousel-item">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect width="100%" height="100%" fill="#777"></rect></svg>
        <img class="bd-placeholder-img img-fluid" alt="Responsive image" width="100%" height="100%" src="<?php echo $path ?>assets/media/bridge.jpg" alt="">
        <div class="container">
  ...
  <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img src="https://personplacething.org/wp-content/uploads/2020/06/person-200x200.jpeg" class="bd-placeholder-img rounded-circle" width="140" height="140">
        ...
        <div class="col-lg-4">
          <img src="https://bdn-data.s3.amazonaws.com/uploads/2020/06/Harrison-Judy-employee-headshot-JCR-1-200x200.jpg" class="bd-placeholder-img rounded-circle" width="140" height="140">
          <div class="mb-4"></div> <!-- spacer -->
          <h2>Gary Roa</h2>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQbV5gsNQGbA1MO_C2_fo2sO5szNvU84y0NKQ&usqp=CAU" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 500x500">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5 order-md-1">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTKzInstje4l60r0rHyY3GVH1Sdig4vEt2-AQ&usqp=CAU" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 500x500">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img src="https://bics.com/wp-content/uploads/2020/02/Full-Service-Solutions.png" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 500x500">
        </div>
      </div>
